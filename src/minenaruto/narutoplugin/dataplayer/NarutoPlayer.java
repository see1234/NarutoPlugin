...
public class NarutoPlayer {
	...
	public void load() {
		...
		this.setHealth(this.getHealth() > 0 ? this.getHealth() : this.getMaxHealth());
	...
	public void  addHealth(double health) {
		double medicalBonus = getDouble("medical");
		double maxHealth = medicalBonus + 20;

		double currentHealth = getHealth();
		double newHealth = currentHealth + health;

		setDouble("health", newHealth);
		double adjustedHealth = Math.max(0, Math.min(newHealth, maxHealth));
		getPlayer().setHealth((adjustedHealth / maxHealth) * 20);
	}
	...
	public void setHealth(double health) {
		double medicalBonus = getDouble("medical");
		double maxHealth = medicalBonus + 20;
		setDouble("health", health);
		double adjustedHealth = Math.max(0, Math.min(health, maxHealth));
		getPlayer().setHealth((adjustedHealth / maxHealth) * 20);
	}
	public double getHealth() {
		return getDouble("health");
	}
	...
	public void sendMessage(String msg) {
		getPlayer().sendMessage("§6§lNaruto §8| §f" + msg.replace("&", "§"));
	}
