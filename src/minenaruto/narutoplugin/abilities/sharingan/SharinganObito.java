...
public class SharinganObito extends AbilitiesMain implements Listener {
    ...
    private Item item = new Item(Material.DIAMOND_HOE, 84, "§7[§6Naruto§7] §4Шаринган Обито (Камуи)", List.of("§7Использование:§f ПКМ;§7Получение новой способки:§f ПКМ+ШИФТ".split(";")));
    ...
    public void entityDamage(EntityDamageEvent e) {
        if (e.getEntity() instanceof Player) {
            if (inKamui.contains((Player)e.getEntity())) {
                e.setCancelled(true);
        }
        }
    }
