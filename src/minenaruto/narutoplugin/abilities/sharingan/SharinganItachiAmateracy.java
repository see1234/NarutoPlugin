...
public class SharinganItachiAmateracy extends AbilitiesMain {
    private Item item = new Item(Material.DIAMOND_HOE, 81, "§7[§6Naruto§7] §4Шаринган Итачи (Аматерасу)", List.of("§7Использование:§f ПКМ;§7Получение новой способки:§f ПКМ+ШИФТ".split(";")));
	@Override
	...
	public void runTaskAbility(Player player) {
		...
		player.sendMessage("§7[§6Naruto§7] §f" + "Вы промахнулись и потратили чакру");
			  ...
			  addDamageEntity(player, entityTarget, 0.01);
		}
