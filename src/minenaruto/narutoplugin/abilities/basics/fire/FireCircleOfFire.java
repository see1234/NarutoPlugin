...
public class FireCircleOfFire extends AbilitiesMain {
    private Item item = new Item(Material.DIAMOND_HOE, 54, "§7[§6Naruto§7] §cКруг огня", List.of("§7Использование:§f ПКМ;§7Получение новой способки:§f ПКМ+ШИФТ".split(";")));
    @Override
        ...
        BukkitRunnable task = new BukkitRunnable() {
            ...
            public void run() {
                if (count++ != 200) {
                    ...
                    spawnParticle(loc.clone().add(new Vector(0, 1, 0)),4);
