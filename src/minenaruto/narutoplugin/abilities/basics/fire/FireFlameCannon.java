...
public class FireFlameCannon extends AbilitiesMain {
    private Item item = new Item(Material.DIAMOND_HOE, 61, "§7[§6Naruto§7] §cПушка пламени", List.of("§7Использование:§f ПКМ;§7Получение новой способки:§f ПКМ+ШИФТ".split(";")));
    @Override
    ...
    public List<ArmorStand> spawnArmorStand(Location loc, int size) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            armorstand.setItemInHand(getModels().get("fireball").getItemStack());
