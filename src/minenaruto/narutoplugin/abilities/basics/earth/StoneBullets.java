...
public class StoneBullets extends AbilitiesMain {
    private Item item = new Item(Material.DIAMOND_HOE, 59, "§7[§6Naruto§7] §6Каменные пули", List.of("§7Использование:§f ПКМ;§7Получение новой способки:§f ПКМ+ШИФТ".split(";")));
	@Override
	...
	//		 armorstands.getOrDefault(player, new ArrayList<Block>());
