...
public class StoneArmor extends AbilitiesMain {
   private Item item = new Item(Material.DIAMOND_HOE, 59, "§7[§6Naruto§7] §6Каменная броня", List.of("§7Использование:§f ПКМ;§7Получение новой способки:§f ПКМ+ШИФТ".split(";")));
	@Override
