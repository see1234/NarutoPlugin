...
public abstract class AkimichiAbility extends AbilitiesMain {
    protected final String abilityName;

    public AkimichiAbility(String abilityName) {
        this.abilityName = abilityName;
    }

    @Override
    public Item getItem() {
        return new Item(Material.DIAMOND_HOE, 22,
            "§7[§6Naruto§7] §cAkimichi: " + abilityName,
