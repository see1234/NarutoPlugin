...
public class RenninganSaskeTeleport extends AbilitiesMain {
    private Item item = new Item(Material.DIAMOND_HOE, 79, "§7[§6Naruto§7] §5Риннеган Саске (Замещение)", List.of("§7Использование:§f ПКМ;§7Получение новой способки:§f ПКМ+ШИФТ".split(";")));
    @Override
