...
public class Item {
	...
	public Item(Material material, int custommodeldata, String displayname, List<String> lore) {
	...
	public ItemStack getItemStack() {
		...
		ItemStack is = new ItemStack(Material.valueOf(material_name.toUpperCase()), 1);
